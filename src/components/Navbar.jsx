...
const sections = [
  { id: "home",     icon: homeIcon,     alt: "Inicio",       label: "Inicio"    },
  { id: "about",    icon: aboutIcon,    alt: "Nosotros",     label: "Nosotros"  },
  { id: "services", icon: servicesIcon, alt: "Productos",    label: "Productos" },
  { id: "aliados",  icon: aliadosIcon,  alt: "Aliados",      label: "Aliados"   },
  { id: "contact",  icon: contactIcon,  alt: "Contacto",     label: "Contacto"  },
];
...
const Navbar = () => {
  ...
  return (
    <nav className="navbar" aria-label="Navegación principal">
      {sections.map(({ id, icon, alt, label }) => (
        <button
          key={id}
